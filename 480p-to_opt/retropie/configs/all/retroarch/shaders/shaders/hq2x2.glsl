...
COMPAT_VARYING mediump vec2 VARc00;
COMPAT_VARYING mediump vec2 VARc01;
COMPAT_VARYING mediump vec2 VARc02;
COMPAT_VARYING mediump vec2 VARc10;
COMPAT_VARYING vec2 VARc11;
COMPAT_VARYING mediump vec2 VARc12;
COMPAT_VARYING mediump vec2 VARc20;
COMPAT_VARYING mediump vec2 VARc21;
COMPAT_VARYING mediump vec2 VARc22;
void main ()
{
    mat4 matrix_1;
    matrix_1 = (MVPMatrix);
...
{
    lowp vec4 tmpvar_1;
    tmpvar_1 = COMPAT_TEXTURE (Texture, VARc00);
    lowp vec4 tmpvar_2;
    tmpvar_2 = COMPAT_TEXTURE (Texture, VARc01);
    lowp vec4 tmpvar_3;
    tmpvar_3 = COMPAT_TEXTURE (Texture, VARc02);
    lowp vec4 tmpvar_4;
    tmpvar_4 = COMPAT_TEXTURE (Texture, VARc10);
    lowp vec4 tmpvar_5;
    tmpvar_5 = COMPAT_TEXTURE (Texture, VARc11);
    lowp vec4 tmpvar_6;
    tmpvar_6 = COMPAT_TEXTURE (Texture, VARc12);
    lowp vec4 tmpvar_7;
    tmpvar_7 = COMPAT_TEXTURE (Texture, VARc20);
    lowp vec4 tmpvar_8;
    tmpvar_8 = COMPAT_TEXTURE (Texture, VARc21);
    lowp vec4 tmpvar_9;
    tmpvar_9 = COMPAT_TEXTURE (Texture, VARc22);
