...
void main()
{
    ...
    _b0075 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP2 = min(_a0075, _b0075);
    _TMP3 = abs(_X);
    _a0079 = _TMP3 + 5.00000000E-001;
    _b0079 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP4 = min(_a0079, _b0079);
    _a0081 = 3.14159274E+000*float(_video_X)*_oneI*_TMP4;
    _TMP5 = sin(_a0081);
    _TMP6 = abs(_X);
    _a0085 = _TMP6 - 5.00000000E-001;
    _b0085 = -1.00000000E+000/(float(_video_X)*_oneI);
    _TMP7 = max(_a0085, _b0085);
    _b0087 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP8 = min(_TMP7, _b0087);
    _TMP9 = abs(_X);
    _a0091 = _TMP9 - 5.00000000E-001;
    _b0091 = -1.00000000E+000/(float(_video_X)*_oneI);
    _TMP10 = max(_a0091, _b0091);
    _b0093 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP11 = min(_TMP10, _b0093);
    _a0095 = 3.14159274E+000*float(_video_X)*_oneI*_TMP11;
    _TMP12 = sin(_a0095);
    _tempColor = _TMP66*((((3.14159274E+000*float(_video_X)*_oneI*_TMP2 + _TMP5) - 3.14159274E+000*float(_video_X)*_oneI*_TMP8) - _TMP12)/6.28318548E+000);
    ...
    _b0109 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP15 = min(_a0109, _b0109);
    _TMP16 = abs(_TMP58);
    _a0113 = _TMP16 + 5.00000000E-001;
    _b0113 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP17 = min(_a0113, _b0113);
    _a0115 = 3.14159274E+000*float(_video_X)*_oneI*_TMP17;
    _TMP18 = sin(_a0115);
    _TMP19 = abs(_TMP58);
    _a0119 = _TMP19 - 5.00000000E-001;
    _b0119 = -1.00000000E+000/(float(_video_X)*_oneI);
    _TMP20 = max(_a0119, _b0119);
    _b0121 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP21 = min(_TMP20, _b0121);
    _TMP22 = abs(_TMP58);
    _a0125 = _TMP22 - 5.00000000E-001;
    _b0125 = -1.00000000E+000/(float(_video_X)*_oneI);
    _TMP23 = max(_a0125, _b0125);
    _b0127 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP24 = min(_TMP23, _b0127);
    _a0129 = 3.14159274E+000*float(_video_X)*_oneI*_TMP24;
    _TMP25 = sin(_a0129);
    _tempColor = _tempColor + _TMP100*((((3.14159274E+000*float(_video_X)*_oneI*_TMP15 + _TMP18) - 3.14159274E+000*float(_video_X)*_oneI*_TMP21) - _TMP25)/6.28318548E+000);
    _X = _TMP58 - 1.00000000E+000;
    ...
    _b0143 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP28 = min(_a0143, _b0143);
    _TMP29 = abs(_X);
    _a0147 = _TMP29 + 5.00000000E-001;
    _b0147 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP30 = min(_a0147, _b0147);
    _a0149 = 3.14159274E+000*float(_video_X)*_oneI*_TMP30;
    _TMP31 = sin(_a0149);
    _TMP32 = abs(_X);
    _a0153 = _TMP32 - 5.00000000E-001;
    _b0153 = -1.00000000E+000/(float(_video_X)*_oneI);
    _TMP33 = max(_a0153, _b0153);
    _b0155 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP34 = min(_TMP33, _b0155);
    _TMP35 = abs(_X);
    _a0159 = _TMP35 - 5.00000000E-001;
    _b0159 = -1.00000000E+000/(float(_video_X)*_oneI);
    _TMP36 = max(_a0159, _b0159);
    _b0161 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP37 = min(_TMP36, _b0161);
    _a0163 = 3.14159274E+000*float(_video_X)*_oneI*_TMP37;
    _TMP38 = sin(_a0163);
    _tempColor = _tempColor + _TMP134*((((3.14159274E+000*float(_video_X)*_oneI*_TMP28 + _TMP31) - 3.14159274E+000*float(_video_X)*_oneI*_TMP34) - _TMP38)/6.28318548E+000);
    ...
    _b0177 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP41 = min(_a0177, _b0177);
    _TMP42 = abs(_X);
    _a0181 = _TMP42 + 5.00000000E-001;
    _b0181 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP43 = min(_a0181, _b0181);
    _a0183 = 3.14159274E+000*float(_video_X)*_oneI*_TMP43;
    _TMP44 = sin(_a0183);
    _TMP45 = abs(_X);
    _a0187 = _TMP45 - 5.00000000E-001;
    _b0187 = -1.00000000E+000/(float(_video_X)*_oneI);
    _TMP46 = max(_a0187, _b0187);
    _b0189 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP47 = min(_TMP46, _b0189);
    _TMP48 = abs(_X);
    _a0193 = _TMP48 - 5.00000000E-001;
    _b0193 = -1.00000000E+000/(float(_video_X)*_oneI);
    _TMP49 = max(_a0193, _b0193);
    _b0195 = 1.00000000E+000/(float(_video_X)*_oneI);
    _TMP50 = min(_TMP49, _b0195);
    _a0197 = 3.14159274E+000*float(_video_X)*_oneI*_TMP50;
    _TMP51 = sin(_a0197);
    _tempColor = _tempColor + _TMP168*((((3.14159274E+000*float(_video_X)*_oneI*_TMP41 + _TMP44) - 3.14159274E+000*float(_video_X)*_oneI*_TMP47) - _TMP51)/6.28318548E+000);
